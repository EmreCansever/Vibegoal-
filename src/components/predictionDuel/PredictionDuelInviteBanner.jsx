export default function PredictionDuelInviteBanner({ invite, theme, onAccept, onDecline, loading }) {
  const t = theme;
  const match = invite.matchSnapshot;
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, fontWeight: 700, color: '#fff', marginBottom: 4 }}>
        🏁 {invite.fromUsername || 'Bir oyuncu'} tahmin düellosu daveti gönderdi!
      </div>
      {match && (
